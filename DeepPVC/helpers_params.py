...
losses = ["L1", "L2", "poisson", "BCE", "Wasserstein", "Poisson", "Sum", "SmoothL1", "lesion", "conv", "edcc", 'sure_poisson']
lr_policies = ["multiplicative", "reduceplateau"]
...
def check_params(params, fatal_on_unknown=False):
    ...
    assert (params['data_normalisation'] in ["global_standard","img_standard","global_0_1","img_0_1","img_mean","none", "img_1_1", "3d_max", "3d_mean", "3d_std", "3d_sum", "3d_softmax", "sino_sum", "act_cons"])
